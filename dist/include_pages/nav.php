<nav class="navbar navbar-custom navbar-fixed-top hidden-xs hidden-sm" role="navigation"> <?php
    $link = "";
    if($english)
    {
        $out = "Svenska?";
