...
?> <html lang="en"><head><meta name="description" content="Klimator homepage"><title>Klimator</title></head><body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top"> <?php include "include_pages/nav.php"?> <!--=============================================== page 0 start ==========================================--><section class="intro" id="page0"> <?php
    if($english){
