...
<section id="page0-5">
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-2 col-md-2 col-sm-2 hidden-xs abote full-height slide-in slide-in-delay-2 slide-in-left">
                <img class="col-lg-12 col-md-12 col-sm-12 hidden-xs center-hori-css" src="img/logo/icon-r.svg"
                     alt="logo"></div>
            ...
            <div class="row">
                <div class="content">
                    <div class="hidden-lg hidden-md center-vertical">
                        <div class="col-xs-12 col-sm-12 tablet-Arbetsomrade-index"><img
                                    class="col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-40 tablet-height-40 no-padding"
                                    src="img/Arbetsomrade1.jpg " alt="Arbetsomrade1"/>
                            <div class="tablet-description col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-5 tablet-height-5">
                                <a class="center-vertical-css"><?php echo $affar1; ?></a></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 tablet-Arbetsomrade-index"><img
                                    class="col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-40 tablet-height-40 no-padding"
                                    src="img/Arbetsomrade2.jpg " alt="Arbetsomrade2"/>
                            <div class="tablet-description col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-5 tablet-height-5">
                                <a class="center-vertical-css"><?php echo $affar2; ?></a></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 tablet-Arbetsomrade-index"><img
                                    class="col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-40 tablet-height-40 no-padding"
                                    src="img/Arbetsomrade3.jpg " alt="Arbetsomrade3"/>
                            <div class="tablet-description col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-5 tablet-height-5">
                                <a class="center-vertical-css"><?php echo $affar3; ?></a></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 tablet-Arbetsomrade-index"><img
                                    class="col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-40 tablet-height-40 no-padding"
                                    src="img/Arbetsomrade4.jpg " alt="Arbetsomrade4"/>
                            <div class="tablet-description col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-5 tablet-height-5">
                                <a class="center-vertical-css"><?php echo $affar4; ?></a></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 tablet-Arbetsomrade-index"><img
                                    class="col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-40 tablet-height-40 no-padding"
                                    src="img/Arbetsomrade5.jpg " alt="Arbetsomrade5"/>
                            <div class="tablet-description col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-5 tablet-height-5">
                                <a class="center-vertical-css"><?php echo $affar5; ?></a></div>
                        </div>
                        <div class="col-xs-12 col-sm-12 tablet-Arbetsomrade-index"><img
                                    class="col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-40 tablet-height-40 no-padding"
                                    src="img/Arbetsomrade6.jpg " alt="Arbetsomrade6"/>
                            <div class="tablet-description col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10 mobile-height-5 tablet-height-5">
                                <a class="center-vertical-css"><?php echo $affar6; ?></a></div>
                        </div>
                    </div>
                    ...
                    <div class="hidden-xs hidden-sm">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 grid fade-in affarsomrade">
                            ...
                            <figure class="effect-zoe"><img class="height-45 mobile-height-15 tablet-height-25"
                                                            src="img/Arbetsomrade1.jpg " alt="Arbetsomrade1"/>
                                <figcaption>
                                    <h2 class="center-hori"><a class="reed-more-afar" href="affarsomrade.php#pagea1">Läs
                                            mer <i class="fa fa-external-link"></i></a></h2>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 grid grid fade-in fade-delay-1 affarsomrade">
                            ...
                            <figure class="effect-zoe"><img class="height-45 mobile-height-15 tablet-height-25"
                                                            src="img/Arbetsomrade2.jpg " alt="Arbetsomrade1"/>
                                <figcaption>
                                    <h2 class="center-hori"><a class="reed-more-afar" href="affarsomrade.php#pagea2">Läs
                                            mer <i class="fa fa-external-link"></i></a></h2>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 grid grid fade-in fade-delay-2 affarsomrade">
                            ...
                            <figure class="effect-zoe"><img class="height-45 mobile-height-15 tablet-height-25"
                                                            src="img/Arbetsomrade3.jpg " alt="Arbetsomrade1"/>
                                <figcaption>
                                    <h2 class="center-hori"><a class="reed-more-afar" href="affarsomrade.php#pagea3">Läs
                                            mer <i class="fa fa-external-link"></i></a></h2>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 grid grid fade-in affarsomrade">
                            ...
                            <figure class="effect-zoe"><img class="height-45 mobile-height-15 tablet-height-25"
                                                            src="img/Arbetsomrade4.jpg " alt="Arbetsomrade1"/>
                                <figcaption>
                                    <h2 class="center-hori"><a class="reed-more-afar" href="affarsomrade.php#pagea4">Läs
                                            mer <i class="fa fa-external-link"></i></a></h2>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 grid grid fade-in fade-delay-1 affarsomrade">
                            ...
                            <figure class="effect-zoe"><img class="height-45 mobile-height-15 tablet-height-25"
                                                            src="img/Arbetsomrade5.jpg " alt="Arbetsomrade1"/>
                                <figcaption>
                                    <h2 class="center-hori"><a class="reed-more-afar" href="affarsomrade.php#pagea5">Läs
                                            mer <i class="fa fa-external-link"></i></a></h2>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 grid grid fade-in fade-delay-2 affarsomrade">
                            ...
                            <figure class="effect-zoe"><img class="height-45 mobile-height-15 tablet-height-25"
                                                            src="img/Arbetsomrade6.jpg " alt="Arbetsomrade1"/>
                                <figcaption>
                                    <h2 class="center-hori"><a class="reed-more-afar" href="affarsomrade.php#pagea6">Läs
                                            mer <i class="fa fa-external-link"></i></a></h2>
...
<section id="page1-5">
    ...
    <p class="fade-in fade-in-delay-1 eu-about">Private cars account for 73% of the passenger traffic in the EU, and 44%
        of all goods in the EU are transported by road. Therefore, proper road maintenance is crucial to ensure traffic
        flow and safety for all road users. Especially during winter, adverse weather conditions are the primary cause
        in many road accidents. Currently, road maintenance contractors take decisions on their interventions mostly
        based on their experience and low-resolution data from meteorological forecasts and stationary weather stations,
        resulting in inefficient resource management and excessive application of salt/de-icing chemicals. High-quality
        data to accurately assess and forecast road status during winter conditions can help to increase the operational
        efficiency and reduce the environmental impact of winter services. Klimator-RSI addresses this challenge by
        bringing into the market a disruptive tool to monitor road status and assist decision-making in winter services
        based. The novelty of Klimator-RSI relies on the establishment of our own mobile sensor infrastructure to
        collect continuous and accurate road status data over large geographic areas, and to provide detailed
        information about friction and road surface properties. In addition, the collected data is integrated with
        “traditional” road weather data from RWIS stations and meteorological forecasts, and then processed in our
        unique climate model and interpreter. Although our service primarily aims to serve road authorities &
        maintenance, the data can also improve traffic flow and safety for road users. Klimator-RSI has already been
        successfully tested in operational environment in Sweden showing that costs of winter road maintenance can be
        reduced by 20-30%. We foresee a potential accumulated revenue for the period 2020-2022 of up to €4.7 M, and the
        creation of 12 new job positions in our company.</p>
    <div class="center-hori-css eu-flag-container">
        <img class="fade-in eu-flag" src="img/eu-flag.jpg">
        <p class="fade-in eu-flag-about">This project has received funding from the European Union’s Horizon 2020
            research and innovation programme under grant agreement No 774187</p>
    </div>
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-vertical forskning fade-in">
                ...
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12"> <?php echo $text; ?>
                    <a target="_blank"
                       href="http://www.gvc.gu.se/forskning/klimat/vagklimat"><br><?php echo $read_more; ?></a></p>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs-down forskning full-height hidden-xs"><img
                        class="col-lg-12 col-md-12 col-sm-12 " src="img/forskning.jpg" alt="forskning"></div>
        </div>
    </div>
</section>
