    ...
    <div class="container-fluid nav-container">
        <div class="navbar-header">
            <a class="navbar-brand page-scroll" href="index.php">
                <img id = "logo-white" class="logo" src="img/logo/Klimator-white.svg" alt="Klimator logo">
                <img id = "logo-dark" class="logo" src="img/logo/Klimator-dark.svg" alt="Klimator logo">
            </a>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-10 col-sm-10 col-md-8 col-lg-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-2 col-lg-offset-2">
                    ...
                    <a href="#pagek1" class="btn btn-circle page-scroll fade-in fade-delay-1"> <img class="logo-button" src="img/logo/icon-r.svg" alt="logo"/> </a> </div>
            </div>
        </div>
    </div>
</section>
...
<section id="pagek1" class="person">
    <div id="person-container" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 container-fluid row full-height">
        <div class="col-lg-6 col-md-6 col-xs-6 persons fade-in"> <img class = "center-hori-css" src="img/Personer/Jorgen Bogren.jpg" alt="Bild på Jörgen Bogren">
        ...
        <div class="col-lg-6 col-md-6 col-xs-6 persons fade-in fade-delay-1"> <img class = "center-hori-css" src="img/Personer/Torbjorn Gustavsson.jpg" alt="Bild på Thorbjörn Gustavsson">
        ...
        <div class="col-lg-4 col-md-4 col-xs-6 persons fade-in"> <img class = "center-hori-css" src="img/Personer/Silke Schau.jpg" alt="Bild på Silke Schau">
        ...
        <div class="col-lg-4 col-md-4 col-xs-6 persons fade-in fade-delay-1"> <img class = "center-hori-css" src="img/Personer/Esben Almkvist.jpg" alt="Bild på Esben Almkvist">
        ...
        <div class="col-lg-6 col-md-6 col-xs-6 persons fade-in fade-delay-2"> <img class = "center-hori-css" src="img/Personer/Anders Bjork.jpg" alt="Bild på Anders Björk">
