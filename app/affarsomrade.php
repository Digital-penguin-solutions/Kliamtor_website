...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato:400,100,300,300italic,700,400italic,700italic,900,900italic" rel="stylesheet" type="text/css">
    <!--======================================= Font =====================================================-->
    ...
    <!--icon-->
    <link rel="shortcut icon" href="img/logo/icon-r2.png" type="image/x-icon"/>
</head>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-10 col-sm-10 col-md-8 col-lg-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-2 col-lg-offset-2">
                    <h1 class="brand-heading fade-in  fade-delay-05 affarsomrade-intro"><?php echo $intro; ?></h1>
                    <a href="#pagea1" class="btn btn-circle page-scroll fade-in fade-delay-1"> <img class="logo-button" src="img/logo/icon-r.svg" alt="logo"/></a> </div>
            </div>
        </div>
    </div>
</section>
...
<section id="pagea1">
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 afarsomraden keep-scroll fade-in fade-delay-0">
                <h1 class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><?php echo $title; ?></h1>
                <!--<img class="hidden-md hidden-lg col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3 mobile-height-60" src="img/rsi.jpg" alt="rsi"> -->
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph1; ?></p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph2;?></p>
                <h2 class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><?php echo $subtitle; ?></h2>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph3; ?> </p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><a target="_blank" href = "http://www.roadstatus.info/"><br><?php echo $read_more1; ?></a></p>
            </div>
            <div class="col-lg-6 col-md-6 hidden-sm hidden-xs afarsomraden half-height fix-to-parent fix-half-width"> <img class="col-lg-12 col-md-12 col-sm-12 " src="img/rsi.jpg" alt="rsi"> </div>
        </div>
    </div>
</section>
...
<section id="pagea2">
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-6 col-md-6 hidden-sm hidden-xs afarsomraden half-height fix-to-parent"> <img class="col-lg-12 col-md-12 col-sm-12 " src="img/bifi.jpg" alt="Bifi"> </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 afarsomraden keep-scroll fix-half-width fade-in fade-delay-0">
                <h1 class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><?php echo $title; ?></h1>
                <!--<img class="hidden-md hidden-lg col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3 mobile-height-60" src="img/rsi.jpg" alt="rsi"> -->
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph1; ?></p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph2; ?></p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph3; ?></p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><a target="_blank" href = "http://bifi.se/"><br><?php echo $read_more2; ?></a></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 afarsomraden keep-scroll fade-in fade-delay-0">
                ...
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph2; ?> </p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><?php echo  $paragraph3; ?><p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><a target="_blank" href = "http://www.roadstatus.info/app/"><br><?php echo $read_more3; ?></a></p>
            </div>
            <div class="col-lg-6 col-md-6 hidden-sm hidden-xs afarsomraden half-height fix-to-parent fix-half-width"> <img class="col-lg-12 col-md-12 col-sm-12 " src="img/vagstabilitet.jpg" alt="affarsomraden"> </div>
        </div>
    </div>
</section>
<!--=============================================== page 4 start ==========================================-->
<section id="pagea4">
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-6 col-md-6 hidden-sm hidden-xs afarsomraden half-height fix-to-parent"> <img class="col-lg-12 col-md-12 col-sm-12 " src="img/vaglagsprognos.jpg" alt="Väglagsprognos"> </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 afarsomraden keep-scroll fix-half-width fade-in fade-delay-0">
                <h1 class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><?php echo $title; ?></h1>
                <!--<img class="hidden-md hidden-lg col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3 mobile-height-60" src="img/rsi.jpg" alt="rsi"> -->
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph1; ?></p>
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 afarsomraden keep-scroll fade-in fade-delay-0">
                ...
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph2; ?></p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph3; ?></p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo $paragraph4; ?></p>
            </div>
            <div class="col-lg-6 col-md-6 hidden-sm hidden-xs afarsomraden half-height fix-to-parent fix-half-width"> <img class="col-lg-12 col-md-12 col-sm-12 " src="img/beslut.jpg" alt="afarsomraden"> </div>
        </div>
    </div>
</section>
<!--=============================================== page 6 start ==========================================-->
<section id="pagea6">
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-6 col-md-6 hidden-sm hidden-xs afarsomraden half-height fix-to-parent"> <img class="col-lg-12 col-md-12 col-sm-12 " src="img/vaderstyrd.jpg" alt="afarsomraden"> </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 afarsomraden keep-scroll fix-half-width fade-in fade-delay-0">
                <h1 class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"><?php echo $title; ?></h1>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo$paragraph1;?></p>
                <p class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1"> <?php echo$paragraph2;?></p>
    ...
    <div class="container-fluid full-height">
        <div class="row full-height">
            <div class="col-lg-12 footer full-height">
                <div class="footer-triangle"> <img class="triangle col-lg-12" src="img/triangel-w.svg" alt="triangel"> </div>
